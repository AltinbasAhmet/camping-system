  ...
  return (
    <section>
      ...
      <div className="mt-8 flex flex-wrap gap-3">
        <Link href="/staff/reservations" className="rounded-2xl bg-emerald-500 px-5 py-3 font-black text-white">Rezervasyonları gör</Link>
        <Link href="/staff/checkin" className="rounded-2xl bg-sky-500 px-5 py-3 font-black text-white">Geldi / Çıktı işlemleri</Link>
      </div>
