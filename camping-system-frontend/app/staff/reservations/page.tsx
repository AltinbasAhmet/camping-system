...
export default function StaffReservationsPage() {
  ...
  return (
    <section>
      <p className="text-sm font-black uppercase tracking-wide text-emerald-700">Salt okunur liste</p>
      <h1 className="mt-2 text-4xl font-black text-emerald-950">Rezervasyonlar</h1>
      <p className="mt-2 text-slate-600">Personel rezervasyonu onaylayamaz, reddedemez veya iptal edemez; yalnızca giriş ve çıkış işlemi yapabilir.</p>
      ...
      <form onSubmit={applyFilters} className="mt-6 grid gap-3 rounded-[2rem] border border-slate-200 bg-white p-5 md:grid-cols-[1fr_1fr_1.4fr_auto]">
        ...
        <button className="rounded-2xl bg-emerald-700 px-5 py-3 font-black text-white">Filtrele</button>
      </form>
