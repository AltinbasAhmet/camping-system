  ...
  return (
    <section className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      <p className="mt-2 text-slate-600">
        Kendi kampında oluşturduğun etkinlikleri buradan yönetebilirsin. Not: kampçıların senin kampında açtığı
        etkinlikler kendi &quot;Etkinliklerim&quot; alanlarında görünür, buradan sadece kendi oluşturdukların listelenir.
      </p>
