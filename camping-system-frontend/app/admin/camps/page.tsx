...
<div className="mt-4 flex flex-wrap items-center gap-2">
  <Link
    className="rounded-full border border-emerald-300 bg-emerald-50 px-4 py-2 text-sm font-bold text-emerald-800 transition hover:bg-emerald-100"
    href={`/camps/${camp.id}`}
  >
    Herkese açık detay
  </Link>
  ...
  <button
    ...
    className="rounded-full border border-red-200 bg-red-50 px-4 py-2 text-sm font-bold text-red-700 transition hover:bg-red-100 disabled:opacity-50"
  >
    Sil
  </button>
</div>
