...
export default function NewCamperEventPage() {
  ...
  async function createEvent(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setTimeout(() => router.push("/my-events"), 1200);
    } catch (err) {
  ...
  return (
    <section className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
      <div className="rounded-[2rem] border border-emerald-100 bg-white p-6 shadow-sm">
        ...
        <p className="mt-2 text-slate-600">Etkinlik bilgilerini ve fotoğraflarını aynı formdan ekleyebilirsiniz. İlk fotoğraf kapak fotoğrafı olur.</p>
