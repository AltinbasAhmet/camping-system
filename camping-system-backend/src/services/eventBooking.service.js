...
async function createEventBooking(userId, data) {
  ...
  // Item: when a ticket is bought, information goes to both the buyer and
  // the person who organized the event (camp owner or camper, whoever organized it).
  notificationService.notifyUserEventTicketPurchased(booking);
  notificationService.notifyOrganizerTicketSold(booking);
